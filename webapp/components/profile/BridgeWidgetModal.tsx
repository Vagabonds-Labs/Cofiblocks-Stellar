...
function BridgeWidgetModal({ isOpen, onClose, recipientAddress }: BridgeWidgetModalProps) {
	...
	return (
		<Modal
			isOpen={isOpen}
			onClose={onClose}
			title={t("profile.bridge_from_other_blockchains") || "Bridge from Other Blockchains"}
		>
				...
				{apiKey ? (
					<div className="w-full overflow-hidden rounded-lg">
						<iframe
							...
							scrolling="no"
							title={t("profile.bridge_from_other_blockchains") || "Rhino Bridge Widget"}
